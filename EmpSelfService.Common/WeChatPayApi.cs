...
namespace EmpSelfService.Common
{
    public class WeChatPayApi
    {
        ...
        public static WeChatPayData Micropay(WeChatPayData inputObj, int timeOut = 10)
        {
            ...
            {
                msg = "提交被扫支付API接口中，缺少必填参数body！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog(msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            else if (!inputObj.IsSet("out_trade_no"))
            {
                msg = "提交被扫支付API接口中，缺少必填参数out_trade_no！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog(msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            ...
            {
                msg = "提交被扫支付API接口中，缺少必填参数total_fee！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog(msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            ...
            {
                msg = "提交被扫支付API接口中，缺少必填参数auth_code！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog(msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            ...
            //签名
            string ss = inputObj.MakeSignNew();
            if (ss.Split('|')[0] == "0")
            {
                inputObj.SetValue("sign", ss.Split('|')[1]);//签名
            }
            else
            {
                msg="生成签名失败：" + ss.Split('|')[1];
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog(msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GenerateReTradeNo()
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}{3}", WeChatPayConfig.SUBMCHID, "02", DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999).ToString().PadLeft(3, '0'));
        }
        ...
        public static WeChatPayData OrderQuery(WeChatPayData inputObj, int timeOut = 6)
        {
            ...
            if (!inputObj.IsSet("out_trade_no") && !inputObj.IsSet("transaction_id"))
            {
                ...
                //LogHelper.WriteLog("*******************************************************", "WeiXin");
                //LogHelper.WriteLog("OrderQuery:订单查询接口中，out_trade_no、transaction_id至少填一个", "WeiXin");
                //LogHelper.WriteLog("*******************************************************", "WeiXin");
            ...
            inputObj.SetValue("appid", WeChatPayConfig.APPID);//公众账号ID
            inputObj.SetValue("mch_id", WeChatPayConfig.MCHID);//商户号
            inputObj.SetValue("sub_mch_id", WeChatPayConfig.SUBMCHID);//商户号
            inputObj.SetValue("nonce_str", WeChatPayApi.GenerateNonceStr());//随机字符串

            inputObj.SetValue("sign", inputObj.MakeSignRc4());//签名
            //string ss = inputObj.MakeSignNew();
            //if (ss.Split('|')[0] == "0")
            //{
            //    inputObj.SetValue("sign", ss.Split('|')[1]);//签名
            ...
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("OrderQuery:" + xml, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            string response = HttpService.Post(xml, url, false, timeOut);//调用HTTP通信接口提交数据
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("OrderQuery" + response, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
        ...
        public static WeChatPayData Reverse(WeChatPayData inputObj, int timeOut = 6)
        {
            ...
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("Reverse:" + xml, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");

            string response = HttpService.Post(xml, url, true, timeOut);

            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("Reverse:" + response, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
        ...
        /// <param name="timeOut">超时时间</param>
        /// <returns>成功时返回，其他抛异常</returns>
        public static WeChatPayData UnifiedOrder(WeChatPayData inputObj,out string msg, int timeOut = 6)
        {
            msg="";
            ...
            if (!inputObj.IsSet("out_trade_no"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:缺少统一支付接口必填参数out_trade_no！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            else if (!inputObj.IsSet("body"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:缺少统一支付接口必填参数body！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            else if (!inputObj.IsSet("total_fee"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:缺少统一支付接口必填参数total_fee！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            ...
            else if (!inputObj.IsSet("trade_type"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:缺少统一支付接口必填参数trade_type！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            ...
            if (inputObj.GetValue("trade_type").ToString() == "JSAPI" && !inputObj.IsSet("openid"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:统一支付接口中，缺少必填参数openid！trade_type为JSAPI时，openid为必填参数！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            if (inputObj.GetValue("trade_type").ToString() == "NATIVE" && !inputObj.IsSet("product_id"))
            {
                ...
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("UnifiedOrder:统一支付接口中，缺少必填参数product_id！trade_type为JSAPI时，product_id为必填参数！", "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            }
            ...
            inputObj.SetValue("appid", WeChatPayConfig.APPID);//公众账号ID
            inputObj.SetValue("sub_appid", WeChatPayConfig.SUBAPPID);//公众账号ID
            inputObj.SetValue("mch_id", WeChatPayConfig.MCHID);//商户号
            inputObj.SetValue("sub_mch_id", WeChatPayConfig.SUBMCHID);//子商户号
            inputObj.SetValue("spbill_create_ip", WeChatPayConfig.IP);//终端ip	  	    
            inputObj.SetValue("nonce_str", GenerateNonceStr());//随机字符串
            ...
            //if (ss.Split('|')[0] =="0")
            //{
            //    inputObj.SetValue("sign", ss.Split('|')[1]);
            //}
            //else
            //{
            //    msg="生成签名失败："+ss.Split('|')[1];
            //    LogHelper.WriteLog("*******************************************************", "WeiXin");
            //    LogHelper.WriteLog("UnifiedOrder:生成签名失败：" + ss.Split('|')[1], "WeiXin");
            //    LogHelper.WriteLog("*******************************************************", "WeiXin");
            ...
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("UnifiedOrder Request:" + xml, "WeiXin");
            LogHelper.WriteLog(" ", "WeiXin");
            string response = HttpService.Post(xml, url, false, timeOut);
            LogHelper.WriteLog("UnifiedOrder Response:" + response, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
	    ...
	    public static WeChatPayData Report(WeChatPayData inputObj,out string msg, int timeOut = 1)
	    {
            msg = "";
            ...
            {
			    msg="接口URL，缺少必填参数interface_url！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("Report:" + msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");

		    } 
            if(!inputObj.IsSet("return_code"))
            {
			    msg="返回状态码，缺少必填参数return_code！";
                LogHelper.WriteLog("*******************************************************", "WeiXin");
                LogHelper.WriteLog("Report:" + msg, "WeiXin");
                LogHelper.WriteLog("*******************************************************", "WeiXin");
            ...
            //    LogHelper.WriteLog("*******************************************************", "WeiXin");
            //    LogHelper.WriteLog("Report:" + "生成签名失败：" + ss.Split('|')[1], "WeiXin");
            //    LogHelper.WriteLog("*******************************************************", "WeiXin");
            //}

		    string xml = inputObj.ToXml();
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("Report:" + xml, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            string response = HttpService.Post(xml, url, false, timeOut);
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            LogHelper.WriteLog("Report:" + response, "WeiXin");
            LogHelper.WriteLog("*******************************************************", "WeiXin");
            WeChatPayData result = new WeChatPayData();
            result.FromXml(response);
		    return result;
        ...
        /// <summary>
        /// 生成业务订单号   根据当前系统时间加随机序列来生成订单号
        /// </summary>
        /// <returns></returns>
        public static string GenerateOutTradeNo(string terminalNo)
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", terminalNo, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999).ToString().PadLeft(3, '0'));
        }
        ...
        /// </summary>
        /// <returns></returns>
        public static string GenerateOutPayTradeNo(string terminalNo)
        {
            var ran = new Random();
            return string.Format("{0}{1}{2}", terminalNo, DateTime.Now.ToString("yyyyMMddHHmmss"), ran.Next(999).ToString().PadLeft(3, '0'));
        }
